...
function chk2()
{
window.location.href="addquestions1.html";
}

function chk3()
{
window.location.href="getdetails.php";
}
function chk4()
{
...
{
window.location.href="reset1.php";
}
}
...
echo'<LABEL><BR /><input  type="submit" NAME="Save" VALUE="Save"  />                 <input type="button" value="Home" name="Home" onclick="chk1();" />                 <input type="button" value="Questions" name="quest" onclick="chk2();" />                 </LABEL><br/><BR/> <input  type="button" NAME="Save" VALUE="View Student Details"  onclick="chk3();"/>  <input  type="button" NAME="reset" VALUE="Delete Account"  onclick="chk4();"/></form>';
echo"</FIELDSET>
