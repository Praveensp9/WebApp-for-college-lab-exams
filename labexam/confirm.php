...
echo"<table border='border' align='center' cellspacing='5' cellpadding='10'><tr valign='center'><th>Sl_no.</th><th>Questions</th></tr>";
                 while($db_field=mysqli_fetch_array($result1,MYSQLI_ASSOC)) {
					...
					echo"</table>";
				echo'<br><form align="center" action="update.php" ><label><input type=submit name="CONFIRM" value="CONFIRM"/></form><br><br>
				<form align="center" action="change.php" ><label><input type=submit name="Change" value="CHANGE OF QUESTION"/></form></body></html>';
